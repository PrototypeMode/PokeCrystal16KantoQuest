...
wAshsName:: ds NAME_LENGTH
wMistysName:: ds NAME_LENGTH
wBrocksName:: ds NAME_LENGTH
wGarysName:: ds NAME_LENGTH
; wPlayerName:: ds NAME_LENGTH
...
wRedsHouse1FSceneID::                             db
wBluesHouse1FSceneID::                            db

wOaksLabSceneID::                                 db
wPalletTownOakSceneID::                           db
