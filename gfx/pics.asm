...
; ShellsterFrontpic: INCBIN "gfx/pokemon/shellster/front.animated.2bpp.lz"
; ShellsterBackpic:  INCBIN "gfx/pokemon/shellster/back.2bpp.lz"
...
RivalGaryPic:      INCBIN "gfx/trainers/rival_gary.2bpp.lz"
RivalAshPic:      INCBIN "gfx/trainers/rival_ash.2bpp.lz"
OmastarBackpic:      INCBIN "gfx/pokemon/omastar/back.2bpp.lz"
SilphGhostFrontpic: INCBIN "gfx/pokemon/silph_ghost/front.animated.2bpp.lz"
SilphGhostBackpic:  INCBIN "gfx/pokemon/silph_ghost/back.2bpp.lz"
