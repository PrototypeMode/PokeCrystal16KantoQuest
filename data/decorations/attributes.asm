...
; entries correspond to deco constants
	...
	decoration DECO_BED,     FEATHERY_BED,    SET_UP_BED,        EVENT_DECO_BED_1,                   $30
	decoration DECO_BED,     PINK_BED,        SET_UP_BED,        EVENT_DECO_BED_2,                   $31
	decoration DECO_BED,     POLKADOT_BED,    SET_UP_BED,        EVENT_DECO_BED_3,                   $32
	decoration DECO_BED,     PIKACHU_BED,     SET_UP_BED,        EVENT_DECO_BED_4,                   $33
	decoration DECO_BED,     GREEN_BED,     SET_UP_BED,        EVENT_DECO_BED_5,                   $34
	
	decoration DECO_PLANT,   PUT_IT_AWAY,     PUT_AWAY_CARPET,   EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1, 0
	decoration DECO_CARPET,  RED_CARPET,      SET_UP_CARPET,     EVENT_DECO_CARPET_1,                $03
	decoration DECO_CARPET,  BLUE_CARPET,     SET_UP_CARPET,     EVENT_DECO_CARPET_2,                $04
	decoration DECO_CARPET,  YELLOW_CARPET,   SET_UP_CARPET,     EVENT_DECO_CARPET_3,                $13
	decoration DECO_CARPET,  GREEN_CARPET,    SET_UP_CARPET,     EVENT_DECO_CARPET_4,                $14

	decoration DECO_PLANT,      PUT_IT_AWAY,        PUT_AWAY_WALLPAPER,   EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1, 0
	decoration DECO_WALLPAPER,  RED_WALLPAPER,      SET_UP_WALLPAPER,     EVENT_DECO_WALLPAPER_1,                $0d
	decoration DECO_WALLPAPER,  BLUE_WALLPAPER,     SET_UP_WALLPAPER,     EVENT_DECO_WALLPAPER_2,                $1d
	decoration DECO_WALLPAPER,  YELLOW_WALLPAPER,   SET_UP_WALLPAPER,     EVENT_DECO_WALLPAPER_3,                $2d
	decoration DECO_WALLPAPER,  GREEN_WALLPAPER,    SET_UP_WALLPAPER,     EVENT_DECO_WALLPAPER_4,                $3d
	...
	decoration DECO_POSTER,  4,               SET_UP_POSTER,     EVENT_DECO_POSTER_2,                $2c
	decoration DECO_POSTER,  5,               SET_UP_POSTER,     EVENT_DECO_POSTER_3,                $2d
	decoration DECO_POSTER,  6,               SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $2e
