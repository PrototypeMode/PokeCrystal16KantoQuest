...
BrockGroup:
	...
	db 10
	 dw GEODUDE
	 dw TACKLE, DEFENSE_CURL, ENDURE, TACKLE
	 
	db 12
	 dw ONIX
	 dw TACKLE, SCREECH, BIND, BIDE  
...
CamperGroup:
	...
	db 7
	dw DIGLETT
	dw SCRATCH, GROWL, MUD_SLAP, NO_MOVE
	db 9
	dw SANDSHREW
	dw SCRATCH, GROWL, SAND_ATTACK, DEFENSE_CURL
...
RivalGaryGroup:
	...
	next_list_item ; RIVAL_GARY (1)
	db "GARY@", TRAINERTYPE_NORMAL
	db 5
	dw BULBASAUR
	db -1 ; end

	next_list_item ; RIVAL_GARY (2)
	db "GARY@", TRAINERTYPE_NORMAL
	db 5
	dw SQUIRTLE
	db -1 ; end
	next_list_item ; RIVAL_GARY (3)
	db "GARY@", TRAINERTYPE_NORMAL
	db 5
	dw CHARMANDER
	db -1 ; end
...
RivalAshGroup:
	...
	next_list_item ; RIVAL_ASH (1)
	db "ASH@", TRAINERTYPE_NORMAL
	db 5
	dw BULBASAUR
	db -1 ; end

	next_list_item ; RIVAL_ASH (2)
	db "ASH@", TRAINERTYPE_NORMAL
	db 5
	dw SQUIRTLE
	db -1 ; end
	
	next_list_item ; RIVAL_ASH (3)
	db "ASH@", TRAINERTYPE_NORMAL
	db 5
	dw CHARMANDER
	db -1 ; end
