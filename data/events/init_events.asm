...
;	dw EVENT_COP_IN_OAKS_LAB
	...
	dw EVENT_BLUES_HOUSE_2F_CONSOLE
	dw EVENT_BLUES_HOUSE_2F_DOLL_1
	dw EVENT_BLUES_HOUSE_2F_DOLL_2
	dw EVENT_BLUES_HOUSE_2F_BIG_DOLL
	
	 dw EVENT_REDS_HOUSE_2F_CONSOLE
	 dw EVENT_REDS_HOUSE_2F_DOLL_1
	 dw EVENT_REDS_HOUSE_2F_DOLL_2
	 dw EVENT_REDS_HOUSE_2F_BIG_DOLL
	...
	dw EVENT_REDS_HOUSE_MOM_2
	dw EVENT_BLUES_HOUSE_DAISY_2
	...
	dw EVENT_EXIT_PALLET
	dw EVENT_OAKS_AIDE_IN_LAB
	
	 dw EVENT_RIVAL_GARY_IN_OAKS_LAB
	 dw EVENT_RIVAL_ASH_IN_OAKS_LAB
	 dw EVENT_MART_BALL
	 dw EVENT_NOT_BEAT_BROCK
	 dw EVENT_NOT_BEAT_MISTY
