...
MapGroup_Olivine:
	...
	map Route38, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OlivineCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map Route42, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_42, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route44, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_44, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map MahoganyTown, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map RuinsOfAlphOutside, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map DragonsDenB1F, TILESET_UNUSED_JOHTO, CAVE, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_46, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BlackthornCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_LakeOfRage:
	...
	map Route43, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_43, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map LakeOfRage, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	assert_table_length NUM_LAKE_OF_RAGE_MAPS

MapGroup_Violet:
	table_width MAP_LENGTH
	map Route32, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map Route35, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route36, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route37, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_37, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VioletCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Pallet:
	...
	map RedsHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouseMom2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_PALLET_RED_HOUSE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_PALLET_BLUE_HOUSE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_PALLET_BLUE_HOUSE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouseDaisy2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_PALLET_BLUE_HOUSE, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMuseum1F, TILESET_LAB, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_LAB, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
		map ViridianForestNorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_RADIO_TOWER, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderTower1F, TILESET_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower2F, TILESET_CEMETERY, DUNGEON, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower3F, TILESET_CEMETERY, DUNGEON, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower4F, TILESET_CEMETERY, DUNGEON, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower5F, TILESET_CEMETERY, DUNGEON, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower6F, TILESET_CEMETERY, DUNGEON, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTower7F, TILESET_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWER, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	table_width MAP_LENGTH
	map Route40, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route41, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CianwoodCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_VIRIDIAN_FOREST, FALSE, PALETTE_NITE, FISHGROUP_POND

	map ViridianForestSouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_VIRIDIAN_MAPS

MapGroup_NewBark:
	table_width MAP_LENGTH
	map Route26, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route27, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route29, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cherrygrove:
	table_width MAP_LENGTH
	map Route30, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_UNUSED_JOHTO, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CherrygroveCity, TILESET_UNUSED_JOHTO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_GlobalTerminal:
	...
	map GlobalTerminalOutside, TILESET_NEW_CITY, ROUTE, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
