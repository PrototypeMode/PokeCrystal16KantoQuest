...
; battle anims
	...
	const ANIM_BLOCKED_POKE_BALL   ; -17 (ffea)
	const ANIM_EXIT_THROW  ; -1 (ffea)
	const ANIM_EXIT_THROW_2  ; -17 (ffea)
	const ANIM_GHOST_FADE  ; -17 (ffea)
	const ANIM_GHOST_FADE_2  ; -17 (ffea)
