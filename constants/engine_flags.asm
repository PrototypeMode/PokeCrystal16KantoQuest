...
;wEliteBadges
	const ENGINE_LORELEI_K
	const ENGINE_BRUNO_K
	const ENGINE_AGATHA_K
	const ENGINE_LANCE_K
	const ENGINE_CHAMP_ASH_K
	const ENGINE_CHAMP_GARY_K
	
	const ENGINE_WILL_J
	const ENGINE_KOGA_J
	const ENGINE_BRUNO_J
	const ENGINE_KAREN_J
	const ENGINE_CHAMP_LANCE_J
