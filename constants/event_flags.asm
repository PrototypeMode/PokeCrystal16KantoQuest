...
; Johto story events
	...
	;const_skip ; unused
	const EVENT_CLEARED_LAVENDER_TOWER
	const EVENT_DEFEATED_GHOST_MAROWAK
...
; Decorations
	...
	const EVENT_DECO_WALLPAPER_1
	const EVENT_DECO_WALLPAPER_2
	const EVENT_DECO_WALLPAPER_3
	const EVENT_DECO_WALLPAPER_4
...
; Unused: next 48 events
	...
	const EVENT_RIVAL_GARY_IN_OAKS_LAB
	const EVENT_RIVAL_ASH_IN_OAKS_LAB
	const EVENT_OAK_IN_OAKS_LAB
	const EVENT_OAK_TOGGLE
	const EVENT_FIRST_RIVAL_BATTLE
	const EVENT_MART_BALL
	const EVENT_MART_GUY
	...
	const EVENT_BLUES_HOUSE_DAISY_1
	const EVENT_BLUES_HOUSE_DAISY_2
	const EVENT_BLUES_HOUSE_1F_NEIGHBOR
	
	const EVENT_BLUES_ROOM_POSTER
	const EVENT_BLUES_HOUSE_2F_CONSOLE
	const EVENT_BLUES_HOUSE_2F_DOLL_1
	const EVENT_BLUES_HOUSE_2F_DOLL_2
	const EVENT_BLUES_HOUSE_2F_BIG_DOLL
	
	const EVENT_EXIT_PALLET
	const EVENT_TALKED_TO_DAISY_AFTER_MYSTERY_EGG_QUEST
	const EVENT_FIRST_TIME_BANKING_WITH_DAISY
	
	const EVENT_REDS_HOUSE_MOM_1
	const EVENT_REDS_HOUSE_MOM_2
	const EVENT_REDS_HOUSE_1F_NEIGHBOR
	
	const EVENT_REDS_ROOM_POSTER
	const EVENT_REDS_HOUSE_2F_CONSOLE
	const EVENT_REDS_HOUSE_2F_DOLL_1
	const EVENT_REDS_HOUSE_2F_DOLL_2
	const EVENT_REDS_HOUSE_2F_BIG_DOLL
