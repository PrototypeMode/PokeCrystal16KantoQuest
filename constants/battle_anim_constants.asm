...
; AnimObjGFX indexes (see data/battle_anims/object_gfx.asm)
	...
	const BATTLE_ANIM_GFX_GREAT_BALL  ; 0b
	const BATTLE_ANIM_GFX_ULTRA_BALL  ; 0b
	const BATTLE_ANIM_GFX_MASTER_BALL  ; 0b
	const BATTLE_ANIM_GFX_FAST_BALL  ; 0b	
	const BATTLE_ANIM_GFX_LOVE_BALL  ; 0b	
	const BATTLE_ANIM_GFX_LURE_BALL  ; 0b	
	const BATTLE_ANIM_GFX_MOON_BALL  ; 0b	
	const BATTLE_ANIM_GFX_HEAVY_BALL  ; 0b	
	const BATTLE_ANIM_GFX_FRIEND_BALL  ; 0b	
	const BATTLE_ANIM_GFX_LEVEL_BALL  ; 0b	
	const BATTLE_ANIM_GFX_PARK_BALL  ; 0b	
	const BATTLE_ANIM_GFX_PREMIER_BALL  ; 0b	
	const BATTLE_ANIM_GFX_GS_BALL  ; 0b	
