...
; SpawnPoints indexes (see data/maps/spawn_points.asm)
	...
	const SPAWN_DEBUG
; kanto
	const SPAWN_PALLET_RED
	const SPAWN_PALLET_BLUE
	const SPAWN_PALLET_OAK
	const SPAWN_VIRIDIAN
	const SPAWN_PEWTER
	const SPAWN_PEWTER_GYM_DOOR
	const SPAWN_PEWTER_GYM_INSIDE
	const SPAWN_CERULEAN
	const SPAWN_CERULEAN_GYM_DOOR
	const SPAWN_CERULEAN_GYM_INSIDE
