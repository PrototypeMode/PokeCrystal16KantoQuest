DEF BLUESHOUSE2F_CARPET1_COINS      EQU 1
DEF BLUESHOUSE2F_CARPET2_COINS      EQU 2
DEF BLUESHOUSE2F_CARPET3_COINS      EQU 3

	object_const_def
	const BLUESHOUSE2F_CONSOLE
	const BLUESHOUSE2F_DOLL_1
	const BLUESHOUSE2F_DOLL_2
	const BLUESHOUSE2F_BIG_DOLL

BluesHouse2F_MapScripts:
	def_scene_scripts
	scene_script BluesHouse2FNoopScene,  SCENE_BLUESHOUSE2F_NOOP

	def_callbacks
	; callback MAPCALLBACK_NEWMAP, BluesHouse2FInitializeRoomCallback
	; callback MAPCALLBACK_TILES, BluesHouse2FSetUpTileDecorationsCallback
    ; callback MAPCALLBACK_CARPETGRAPHICS, BluesHouseRenderCarpetCallback
	; callback MAPCALLBACK_WALLPAPERGRAPHICS, BluesHouseRenderWallpaperCallback
	
BluesHouse2FNoopScene: ; unreferenced
...
BluesHouse2FInitializeRoomCallback:
...
BluesHouse2FSetUpTileDecorationsCallback:
	special ToggleMaptileDecorations
	endcallback

BluesHouseRenderCarpetCallback:
	special CoverTilesWithCarpet
	endcallback
	
BluesHouseRenderWallpaperCallback:
...
Text_LikeTheLook3:
	...
	BluesHouse2FMovementData_BlueSpinsClockwiseEndsFacingRight:
	turn_head DOWN
	turn_head LEFT
	turn_head UP
	turn_head RIGHT
	...
	BluesHouse2FMovementData_BlueSpinsClockwiseEndsFacingDown:
	turn_head UP
	turn_head RIGHT
	turn_head LEFT
	turn_head DOWN
...
BluesHouse2FMovementData_BlueTakesOneStepUp_2:
	step UP
	step_end	

BluesHouseDoll1Script::
     describedecoration DECODESC_LEFT_DOLL	

BluesHouseDoll2Script:
	describedecoration DECODESC_RIGHT_DOLL

BluesHouseBigDollScript:
	describedecoration DECODESC_BIG_DOLL
	
BluesHouseControllerScript:
	;setevent EVENT_USE_NES

BluesHouseGameConsoleScript:	 
...
.BluesHouseGameConsoleScriptN64:	 
     ; refreshscreen
...
.BluesHouseGameConsoleScriptNES:
     ; refreshscreen
	 ; changeblock 3, 3, $1d ; ladder
	 ; reloadmappart	
	 describedecoration DECODESC_CONSOLE
	 end
.BluesHouseGameConsoleScriptSNES:	 
     ; refreshscreen
...
.BluesHouseGameConsoleScriptVirtualBoy:	 
     ; refreshscreen
	 ; changeblock 3, 3, $01 ; ladder
	 ; reloadmappart	
	 describedecoration DECODESC_CONSOLE
...
BluesHouseRadioScript:
	...
	opentext
	writetext BluesRadioText1
	pause 45
	writetext BluesRadioText2
	pause 45
	writetext BluesRadioText3
	pause 45
	musicfadeout MUSIC_NEW_BARK_TOWN, 16
	writetext BluesRadioText4
	pause 45
	closetext
...
BluesHouseBookshelfScript:

	jumpstd PictureBookshelfScript


BluesHouse2FDecoVendorScript:
	opentext
	writetext BluesHouse2FDecoVendorIntroText
	yesorno
	iftrue BluesHouse_Yes
	iffalse .Cancel

.Cancel
    sjump BluesHouse2FDecoVendor_CancelPurchaseScript	
...
.AshCostume:
	opentext
	writetext Text_ChangeTheLook3
	waitbutton
	closetext
	playsound SFX_TINGLE
	applymovement PLAYER, BluesHouse2FMovementData_BlueSpinsClockwiseEndsFacingRight

	setval (PAL_NPC_RED << 4)
	special SetPlayerPalette
	callasm .PickAsh
	applymovement PLAYER, BluesHouse2FMovementData_BlueSpinsClockwiseEndsFacingDown
	special UpdatePlayerSprite
	
	opentext
	writetext Text_LikeTheLook3
	waitbutton
	closetext
...
BluesHouse2FDecoVendor_AlreadyHaveDecoText:
	text "You already have"
	line "this decoration!"
	done

BluesHouse2FDecoVendorIntroText:
	text "Change your"
    line "outfit?"
    done	
...
BluesHouse2FDecoVendorWhichDecoText:
	text "What will"
	line "you wear today?"
	done
...
BluesHouse2FDecoVendorHereYouGoText:
	text "Enjoy!"
	done

BluesHouse2FDecoVendorNeedMoreCoinsText:
	text "Sorry! You need"
	line "more coins."
	done

BluesHouse2FDecoVendorNoMoreRoomText:
	text "Sorry. You can't"
	line "carry any more."
	done

BluesHouse2FDecoVendorQuitText:
	text "Hmm... I can't"
	line "decide what"
	cont "to wear!"
	done

BluesHouse2FDecoVendorNoCoinCaseText:
...
BluesHouse2FDecoVendor_NotEnoughCoinsScript:
	writetext BluesHouse2FDecoVendorNeedMoreCoinsText
	waitbutton
	closetext
	end

; BluesHouse2FDecoMonVendor_NoRoomForPrizeScript:
	; writetext BluesHouse2FDecoVendorNoMoreRoomText
	; waitbutton
	; closetext
	; end

BluesHouse2FDecoVendor_CancelPurchaseScript:
	writetext BluesHouse2FDecoVendorQuitText
	waitbutton
	closetext
	end

BluesHouse2FDecoVendor_NoCoinCaseScript:
...
BluesHouse2F_MapEvents:
	...
	def_bg_events
	bg_event  0,  1, BGEVENT_UP, BluesHousePCScript
	bg_event  2,  1, BGEVENT_READ, BluesHouseRadioScript
	bg_event  6,  1, BGEVENT_READ, BluesHouse2FDecoVendorScript
	bg_event  5,  0, BGEVENT_IFSET, BluesHousePosterScript

	def_object_events
	object_event  3,  2, SPRITE_CONSOLE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BluesHouseGameConsoleScript, EVENT_BLUES_HOUSE_2F_CONSOLE
	object_event  7,  5, SPRITE_DOLL_1, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BluesHouseDoll1Script, EVENT_BLUES_HOUSE_2F_DOLL_1
	object_event  6,  5, SPRITE_DOLL_2, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BluesHouseDoll2Script, EVENT_BLUES_HOUSE_2F_DOLL_2
	object_event 10,  5, SPRITE_BIG_DOLL, SPRITEMOVEDATA_BIGDOLL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BluesHouseBigDollScript, EVENT_BLUES_HOUSE_2F_BIG_DOLL
