DEF REDSHOUSE2F_CARPET1_COINS      EQU 1
DEF REDSHOUSE2F_CARPET2_COINS      EQU 2
DEF REDSHOUSE2F_CARPET3_COINS      EQU 3
...
RedsHouse2F_MapScripts:
	def_scene_scripts
	scene_script RedsHouse2FNoopScene,  SCENE_REDSHOUSE2F_NOOP
	...
	callback MAPCALLBACK_TILES, RedsHouse2FSetUpTileDecorationsCallback
     callback MAPCALLBACK_CARPETGRAPHICS, RedsHouseRenderCarpetCallback
	 callback MAPCALLBACK_WALLPAPERGRAPHICS, RedsHouseRenderWallpaperCallback
	
RedsHouse2FNoopScene: ; unreferenced
...
RedsHouseRenderCarpetCallback:
	special CoverTilesWithCarpet
	endcallback
	
RedsHouseRenderWallpaperCallback:
...
Text_LikeTheLook4:
	...
	RedsHouse2FMovementData_BlueSpinsClockwiseEndsFacingRight:
	turn_head DOWN
	turn_head LEFT
	turn_head UP
	turn_head RIGHT
	...
	RedsHouse2FMovementData_BlueSpinsClockwiseEndsFacingDown:
	turn_head UP
	turn_head RIGHT
	turn_head LEFT
	turn_head DOWN
...
RedsHouse2FMovementData_BlueTakesOneStepUp_2:
	step UP
	step_end	
...
.RedsHouseGameConsoleScriptNES:
     ; refreshscreen
	 ; changeblock 3, 3, $1d ; ladder
	 ; reloadmappart	
	 describedecoration DECODESC_CONSOLE
	 end
.RedsHouseGameConsoleScriptSNES:	 
     ; refreshscreen
...
.RedsHouseGameConsoleScriptVirtualBoy:	 
     ; refreshscreen
	 ; changeblock 3, 3, $01 ; ladder
	 ; reloadmappart	
	 describedecoration DECODESC_CONSOLE
...
RedsHouseRadioScript:
	...
	opentext
	writetext RedsRadioText1
	pause 45
	writetext RedsRadioText2
	pause 45
	writetext RedsRadioText3
	pause 45
	musicfadeout MUSIC_NEW_BARK_TOWN, 16
	writetext RedsRadioText4
	pause 45
	closetext
...
RedsHouseBookshelfScript:

	jumpstd PictureBookshelfScript


RedsHouse2FDecoVendorScript:
	opentext
	writetext RedsHouse2FDecoVendorIntroText
	yesorno
	iftrue RedsHouse_Yes
	iffalse .Cancel

.Cancel
    sjump RedsHouse2FDecoVendor_CancelPurchaseScript	
	
;.CheckCoin	
;	checkitem COIN_CASE
;	iffalse RedsHouse2FDecoVendor_NoCoinCaseScript

RedsHouse_Yes:
    closetext
	opentext
	writetext RedsHouse2FDecoVendorWhichDecoText
...
.AshCostume:
	opentext
	writetext Text_ChangeTheLook4
	waitbutton
	closetext
	playsound SFX_TINGLE
	applymovement PLAYER, RedsHouse2FMovementData_BlueSpinsClockwiseEndsFacingRight

	setval (PAL_NPC_RED << 4)
	special SetPlayerPalette
	callasm .PickAsh
	applymovement PLAYER, RedsHouse2FMovementData_BlueSpinsClockwiseEndsFacingDown
	special UpdatePlayerSprite
	
	opentext
	writetext Text_LikeTheLook4
	waitbutton
	closetext
...
;.Carpet1:
 	 ; checkcoins REDSHOUSE2F_CARPET1_COINS
	 ; ifequal HAVE_LESS, RedsHouse2FDecoVendor_NotEnoughCoinsScript
	 ; checkevent EVENT_DECO_CARPET_1
	 ; iftrue .AlreadyHaveDecoItem
	 ; setevent EVENT_DECO_CARPET_1
	 ; takecoins REDSHOUSE2F_CARPET1_COINS
	  ; waitsfx
	 ; playsound SFX_TRANSACTION
	  ; writetext RedsHouse2FDecoVendorHereYouGoText
	  ; waitbutton
	  ; sjump .loop
	  
 ; .Carpet2:
 	 ; checkcoins REDSHOUSE2F_CARPET2_COINS
	 ; ifequal HAVE_LESS, RedsHouse2FDecoVendor_NotEnoughCoinsScript
	 ; checkevent EVENT_DECO_CARPET_2
	 ; iftrue .AlreadyHaveDecoItem
	 ; setevent EVENT_DECO_CARPET_2
	 ; takecoins REDSHOUSE2F_CARPET2_COINS
	  ; waitsfx
	 ; playsound SFX_TRANSACTION
	  ; writetext RedsHouse2FDecoVendorHereYouGoText
	  ; waitbutton
 ...
 ; .Carpet3:
 	 ; checkcoins REDSHOUSE2F_CARPET3_COINS
	 ; ifequal HAVE_LESS, RedsHouse2FDecoVendor_NotEnoughCoinsScript
	 ; checkevent EVENT_DECO_CARPET_3
	 ; iftrue .AlreadyHaveDecoItem
	 ; setevent EVENT_DECO_CARPET_3
	 ; takecoins REDSHOUSE2F_CARPET3_COINS
	  ; waitsfx
	 ; playsound SFX_TRANSACTION
	  ; writetext RedsHouse2FDecoVendorHereYouGoText
	  ; waitbutton
...
.AlreadyHaveDecoItem
	writetext RedsHouse2FDecoVendor_AlreadyHaveDecoText
	waitbutton
	 sjump .loop
	 end
	 
RedsHouse2FDecoVendor_AlreadyHaveDecoText:
	text "You already have"
	line "this decoration!"
	done

RedsHouse2FDecoVendorIntroText:
	text "Change your"
    line "outfit?"
    done	
...
RedsHouse2FDecoVendorWhichDecoText:
	text "What will"
	line "you wear today?"
	done

; RedsHouse2FPrizeVendorConfirmPrizeText:
	; text_ram wStringBuffer3
	; text "."
	; line "Is that right?"
	; done

RedsHouse2FDecoVendorHereYouGoText:
	text "Enjoy!"
	done

RedsHouse2FDecoVendorNeedMoreCoinsText:
	text "Sorry! You need"
	line "more coins."
	done

RedsHouse2FDecoVendorNoMoreRoomText:
	text "Sorry. You can't"
	line "carry any more."
	done

RedsHouse2FDecoVendorQuitText:
	text "Hmm... I can't"
	line "decide what"
	cont "to wear!"
	done

RedsHouse2FDecoVendorNoCoinCaseText:
...
RedsHouse2FDecoVendor_NotEnoughCoinsScript:
	writetext RedsHouse2FDecoVendorNeedMoreCoinsText
	waitbutton
	closetext
	end

; RedsHouse2FDecoMonVendor_NoRoomForPrizeScript:
	; writetext RedsHouse2FDecoVendorNoMoreRoomText
	; waitbutton
	; closetext
	; end

RedsHouse2FDecoVendor_CancelPurchaseScript:
	writetext RedsHouse2FDecoVendorQuitText
	waitbutton
	closetext
	end

RedsHouse2FDecoVendor_NoCoinCaseScript:
	writetext RedsHouse2FDecoVendorNoCoinCaseText
	waitbutton
	closetext
	end
...
RedsHouse2F_MapEvents:
	...
	def_bg_events
;	bg_event  3,  1, BGEVENT_UP, TVScript
	bg_event  0,  1, BGEVENT_UP, RedsHousePCScript
	bg_event  2,  1, BGEVENT_READ, RedsHouseRadioScript
	bg_event  6,  1, BGEVENT_READ, RedsHouse2FDecoVendorScript
