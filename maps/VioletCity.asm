...
VioletCity_MapEvents:
	...
	warp_event 36,  5, VIOLET_GYM, 1
	warp_event 29, 17, EARLS_POKEMON_ACADEMY, 1
	warp_event  3, 15, VIOLET_NICKNAME_SPEECH_HOUSE, 1
	warp_event 19, 17, VIOLET_POKECENTER_1F, 1
	warp_event 31, 25, VIOLET_KYLES_HOUSE, 1
	...
	bg_event 22, 17, BGEVENT_READ, VioletGymSign
	...
	object_event 34,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VioletCityRareCandy, EVENT_VIOLET_CITY_RARE_CANDY
