	...
	const ROUTE34ILEXFORESTGATE_BUTERFREE
...
;	object_event  9,  4, SPRITE_BUTTERFREE, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, Route34IlexForestGateButterfreeScript, -1
