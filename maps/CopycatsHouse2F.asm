...
.Default_Female_1:
	...
	faceplayer
	variablesprite SPRITE_COPYCAT, SPRITE_OLD_MISTY
.Default_Merge_1:
...
CopycatsHouse2F_MapEvents:
	...
	object_event  6,  4, SPRITE_FARFETCHD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CopycatsDodrio, -1
